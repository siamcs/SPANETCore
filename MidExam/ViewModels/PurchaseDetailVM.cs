...
namespace MidExam.ViewModels
{
    ...
    public class PurchaseDetailVM()
    {
        ...
        public PurchaseDetailVM(int productId, 
            decimal quantity, int measurementUnitId, 
            decimal unitPrice, decimal totalPrice) : this(productId,
                quantity, measurementUnitId, unitPrice)
        {
